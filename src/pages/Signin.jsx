...
import { FiMail, FiLock, FiUser, FiEye, FiEyeOff } from "react-icons/fi"; // Consolidated imports!
...
const Signin = () => {
  ...
  return (
    // 1. Removed the inline style from this main wrapper and added 'relative z-0'
    <div className="relative z-0 min-h-[100dvh] w-full bg-gradient-to-br from-gray-50 via-indigo-50 to-purple-50 dark:from-gray-900 dark:via-slate-800 dark:to-indigo-950 overflow-y-auto">
      ...
      {/* 2. THE MAGIC BACKGROUND LAYER */}
      {/* Hidden on mobile ('hidden'), visible on desktop ('sm:block'), pushed behind content ('-z-10') */}
      <div 
      ...
      <div className="flex items-center justify-center min-h-[100dvh] sm:px-4 sm:py-8">
        ...
        <div className="w-full max-w-md sm:bg-white/80 sm:dark:bg-gray-900/80 sm:backdrop-blur-xl sm:border sm:border-gray-200 sm:dark:border-gray-700 sm:shadow-2xl sm:rounded-3xl p-6 sm:p-8 transition-all duration-300 text-slate-900 dark:text-white">
          ...
          <div className="space-y-5">
            ...
            {isLogin && (
              <div className="flex justify-end">
                <button className="text-sm text-blue-600 dark:text-blue-400 hover:underline">Forgot password?</button>
              </div>
            )}
  ...
  onClick={() => navigate(isLogin ? "/dashboard" : "/welcome")}
>
  {isLogin ? "Sign In" : "Create Account"}
            ...
            <button className="w-full py-3.5 rounded-xl border border-gray-300/50 dark:border-gray-700 bg-white/50 dark:bg-gray-800/50 sm:bg-transparent hover:bg-white dark:hover:bg-gray-800 transition font-medium text-sm">
